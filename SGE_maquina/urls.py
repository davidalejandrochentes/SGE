...
urlpatterns = [
    ...
    path('mod_mantenimineto_maquina/<int:id>', views.mod_mantenimineto_maquina, name="mod_mantenimineto_maquina"),
    ...
    path('nuevo_mantenimineto_maquina/<int:id>', views.nuevo_mantenimineto_maquina, name="nuevo_mantenimineto_maquina"),
]
